...
namespace Entity.Concrete
{
    ...
    {
        string sicil, personelAdSoyad, tc; DateTime dogumTarihi; string dogumYeri, telefon, ikametAdresi, mezuniyetBilgisi;
        ...
        public Personel(string sicil, string personelAdSoyad, string tc, DateTime dogumTarihi, string dogumYeri, string telefon, string ikametAdresi, string mezuniyetBilgisi)
        {
            this.sicil = sicil;
        ...
        {
            return $"Sicil: {Sicil}, AdSoyad: {PersonelAdSoyad}";
        }
